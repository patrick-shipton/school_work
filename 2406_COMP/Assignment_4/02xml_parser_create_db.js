/*
This code breaks down html files that follow the structure of "explanation of recipe XML tags.txt" (ex: aLaCarteData_rev3.xml)
It then loads the data into a database (which will be used by a server)
